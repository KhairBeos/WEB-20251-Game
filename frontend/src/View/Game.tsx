...
function Game() {
  ...
  const {imageRef:tankFeatureRef,isImageLoaded:isFeatureLoaded, images: tankFeatureImages} = useLoadTankFeatures()
  ...
  const animate = useCallback(() => {
    ...
    tankHealthAnimation(ctx, tankStateRef, keysPressed, tankFeatureRef, tankFeatureImages, tankAnimationState);
    ...
    animationFrameId.current = requestAnimationFrame(animate);
  }, [isImageLoaded, isGunImageLoaded, isLazeImageLoaded, isBulletImageLoaded, isTreeImageLoaded, isBushImageLoaded, isMapLoaded, isMapIconsLoaded, isFeatureLoaded, drawMapCB, socket, viewport, tankMovingAnimationCB, tankGunAnimationCB, tankBulletAnimationCB, tankUpdatePosistionCB]);
